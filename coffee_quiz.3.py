...
st.markdown(
    ...
    '<div class="hero-subtitle">Descubre el café que realmente va contigo</div>'
    '</div>',
    unsafe_allow_html=True
)
...
st.markdown(
    ...
    '<div class="question-title">¿Qué tan dulce te gusta?</div>'
    '<div class="question-subtitle">Elige rápido. No hay respuesta correcta.</div>'
    '</div>',
    unsafe_allow_html=True
)
